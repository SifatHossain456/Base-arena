            ...
            <div className="hidden md:flex items-center gap-3">
              {isConnected && address ? (
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-gradient-blue text-white px-5 py-2 rounded-xl text-sm font-semibold hover:opacity-90 transition-opacity glow-blue"
                >
                ...
                <div className="pt-2 border-t border-white/5">
                  {isConnected && address ? (
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 bg-gradient-blue text-white px-5 py-3 rounded-xl text-sm font-semibold"
                    >
                      <Wallet className="w-4 h-4" />
                      Connect Wallet
                    </button>
